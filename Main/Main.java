...
public class Main {
	public static void main(String[] args) {
        ...
        //Static test input
        //int[] input = new int[]{89,55,57,54,12,51,54,93,55,6,26,45,79,99,40,84,67,78,5,6,57,14,56,56,25,11,10,35,83,65,11,12,84,92,45,58,49,38,39,
        //    4,40,12,29,91,18,85,13,65,65,100,46,47,100,58,42,38,1,54,87,8,66,9,8,28,68,86,25,17,91,91,23,51,75,38,99,24,69,93,11,14,56,42,28,41,18,
        //    92,83,85,66,42,13,71,7,49,100,12,74,65,58,25};
        
        //Visually symmetric input(even differences)
        int[] input = new int[]{ 295, 125, 10, 440, 435, 480, 185, 65, 5, 55, 210, 255, 285, 220, 250, 325, 145, 415, 25, 205,
       ...
       //Bubble Sort
        ...
        before = System.currentTimeMillis();
        ss.solution(Arrays.copyOf(input, input.length));
        after = System.currentTimeMillis();
        calculateTime(before, after);
